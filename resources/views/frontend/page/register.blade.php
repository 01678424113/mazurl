...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form method="post" accept-charset="utf-8" id="signup-form" action="{{route('doRegisterView')}}">
            @csrf
            <div class="form-group text  required">
                <input type="text" name="name" placeholder="Your name" class="form-control" required="required"
                       maxlength="150" id="name" value=""/></div>
            <div class="form-group email  required">
                <input type="email" name="email" placeholder="Email" class="form-control" required="required"
                       maxlength="254" id="email" value=""/></div>
            <div class="form-group password  required">
                <input type="password" name="password" placeholder="Password" class="form-control" required="required"
                       id="password" value=""/></div>
            <div class="form-group password  required"><input type="password" name="password_confirmation"
                                                              placeholder="Confirm password" class="form-control"
                                                              required="required" id="password_confirmation"/></div>

            <button class="btn btn-primary btn-block btn-flat btn-captcha" id="invisibleCaptchaSignup" type="submit">
                Register
            </button>
        </form>
        ...
        <a href="{{route('loginView')}}" class="text-center">
